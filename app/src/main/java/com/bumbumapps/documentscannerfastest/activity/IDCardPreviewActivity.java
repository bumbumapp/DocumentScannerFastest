...
import com.bumbumapps.documentscannerfastest.scrapbook.ImageStickerConfig;
import com.bumbumapps.documentscannerfastest.scrapbook.LocalDisplay;
import com.bumbumapps.documentscannerfastest.scrapbook.StickerConfigInterface;
import com.bumbumapps.documentscannerfastest.scrapbook.StickerHolderView;
import com.bumbumapps.documentscannerfastest.scrapbook.TextStickerConfig;
...
public class IDCardPreviewActivity extends BaseActivity implements View.OnClickListener, StickerHolderView.OnStickerSelectionCallback {
    ...
    private class saveIDCard extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        public void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(IDCardPreviewActivity.this,R.style.CustomDialog);
        ...
        public Bitmap doInBackground(Bitmap... bitmapArr) {
            ...
            if (Constant.inputType.equals("Group")) {
                group_name = "FastestScanner" + Constant.getDateTime("_ddMMHHmmss");
