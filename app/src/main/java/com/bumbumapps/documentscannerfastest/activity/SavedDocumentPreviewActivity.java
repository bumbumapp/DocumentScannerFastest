...
import com.bumbumapps.documentscannerfastest.adapter.PreviewPagerAdapter;
import com.bumbumapps.documentscannerfastest.adapter.SavedToolsAdapter;
import com.bumbumapps.documentscannerfastest.db.DBHelper;
import com.bumbumapps.documentscannerfastest.document_view.ViewPagerFixed;
...
import com.bumbumapps.documentscannerfastest.models.SavedToolType;
...
//        currentDocList = GroupDocumentActivity.currentGroupList;
    ...
    public class getAllDoc extends AsyncTask<String, Void, String> {
        ...
        public void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(SavedDocumentPreviewActivity.this,R.style.CustomDialog);
