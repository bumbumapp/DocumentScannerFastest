...
import com.bumbumapps.documentscannerfastest.adapter.ColorEffectAdapter;
import com.bumbumapps.documentscannerfastest.adapter.ColorFilterAdapter;
import com.bumbumapps.documentscannerfastest.adapter.EditToolsAdapter;
import com.bumbumapps.documentscannerfastest.adapter.FontAdapter;
import com.bumbumapps.documentscannerfastest.adapter.OverlayAdapter;
import com.bumbumapps.documentscannerfastest.adapter.SignatureAdapter;
import com.bumbumapps.documentscannerfastest.adapter.WatermarkFontAdapter;
import com.bumbumapps.documentscannerfastest.db.DBHelper;
import com.bumbumapps.documentscannerfastest.document_view.ColorFilter;
import com.bumbumapps.documentscannerfastest.main_utils.AdjustUtil;
...
import com.bumbumapps.documentscannerfastest.models.EditToolType;
...
//        ly_aspectratio.setAspectRatio((float) Constant.original.getWidth(), (float) Constant.original.getHeight());
        ...
        defaultTxtColor = getResources().getColor(R.color.dark_color);
...
//        editText.setTextColor(defaultTxtColor);
    ...
    private class saveSignature extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        public void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(DocumentEditorActivity.this,R.style.CustomDialog);
